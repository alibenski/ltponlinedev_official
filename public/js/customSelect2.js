  $(document).ready(function(){
      $(".wx").select2({
        ...
        "language": {
            "noResults": function(){
                return "<strong class='text-danger'>Sorry no schedule offered for this course this term. </strong><br> <a href='https://learning.unog.ch/sites/default/files/ContainerEn/LTP/Admin/ClassSchedule_en_fr.pdf' target='_blank' class='btn btn-info'>click here to see the available courses and their schedules</a>";
                }
        },
