...
class SendGeneralEmailJob implements ShouldQueue
{
    ...
    {
        Mail::raw("General Email Delivery Job Failure. Something is wrong with the code in App\Jobs\SendGeneralEmailJob. There was an error executing sendGeneralEmail.php. Stop cron/queue:work, fix the code, do queue:restart, then do queue:work or restart CRON", function ($message) {
