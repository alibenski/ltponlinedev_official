...
class SendReminderEmailHR extends Mailable
{
    ...
    public function build()
    {
        return $this->view('emails.approvalhr')
                    ...
                    ->priority(1)
                    ->subject('Reminder - CLM Learning Partner Approval Needed for: '.$this->staff_name.' on Language Course Enrolment '.$this->input_course->courses->Description.' ('.$this->term_season_en.' '.$this->term_year.')');
    }
}
