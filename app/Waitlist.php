...
class Waitlist extends Model
{
    ...
    protected $table = 'tblLTP_Waitlist';
    protected $fillable = [
        'id', 'CodeIndexID', 'Code', 'Te_Code', 'schedule_id', 'Term', 'INDEXID', 'mgr_email', 'mgr_fname', 'mgr_lname', 'L', 'profile', 'continue_bool', 'approval', 'approval_hr', 'DEPT', 'country_mission', 'ngo_name', 'attachment_id', 'attachment_pay', 'is_self_pay_form', 'selfpay_approval', 'form_counter', 'eform_submit_count', 'cancelled_by_student', 'agreementBtn', 'consentBtn', 'flexibleBtn', 'flexibleDay', 'flexibleTime', 'flexibleFormat', 'contractDate',
    ];
    /**
