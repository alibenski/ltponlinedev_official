...
class Repo extends Model
{
    ...
    protected $fillable = [
        'CodeIndexIDClass', 'CodeClass', 'schedule_id', 'CodeIndexID', 'Code', 'Te_Code', 'Term', 'INDEXID', 'EMAIL', 'L', 'DEPT', 'country_mission', 'ngo_name', 'PS', 'Comments', 'created_at', 'UpdatedOn', 'is_self_pay_form', 'flexibleBtn', 'flexibleDay', 'flexibleTime', 'flexibleFormat', 'form_counter', 'eform_submit_count', 'convocation_email_sent', 'Written', 'Oral', 'Result', 'Overall_Grade', 'cancelled_by', 'teacher_comments', 'admin_eform_comment', 'admin_plform_comment', 'admin_eform_cancel_comment', 'admin_plform_cancel_comment', 'std_comments', 'hr_comments', 'course_preference_comment', 'pash_remark', 'last_remark_by', 'exclude_from_billing', 'excluded_by', 'no_show', 'no_show_by',
    ];
    ...
    {
        return $this->belongsTo('App\Torgan',  'DEPT', 'Org name');
    }
}
