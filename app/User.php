...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'indexno', 'name', 'indexno_old', 'nameFirst', 'nameLast', 'email', 'temp_email', 'password', 'must_change_password', 'approved_account', 'approved_update', 'account_token', 'update_token',
    ];
