...
class AjaxController extends Controller
{
    ...
    {
        if($request->ajax()){
            $selfpay_student = Preenrolment::select( 'INDEXID','Te_Code','profile', 'DEPT')->where('INDEXID', $request->index)->where('Te_Code', $request->tecode)->where('Term', $request->term)->first();    
