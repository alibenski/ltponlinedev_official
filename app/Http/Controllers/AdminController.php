...
class AdminController extends Controller
{
    ...
    {
        $results = \DB::select("INSERT into LTP_PASHQTcur (INDEXID,CodeIndexIDClass,CodeClass,CodeIndexID,Code,schedule_id,Te_Code,L,is_self_pay_form,flexibleBtn,flexibleDay,flexibleTime,flexibleFormat,convocation_email_sent,form_counter,eform_submit_count,Term,DEPT,PS,created_at,UpdatedOn,deleted_at,EMAIL,Comments,std_comments, hr_comments, teacher_comments,  admin_eform_comment, admin_plform_comment, course_preference_comment) SELECT INDEXID,CodeIndexIDClass,CodeClass,CodeIndexID,Code,schedule_id,Te_Code,L,is_self_pay_form,flexibleBtn,flexibleDay,flexibleTime,flexibleFormat,convocation_email_sent,form_counter,eform_submit_count,Term,DEPT,PS,created_at,UpdatedOn,deleted_at,EMAIL,Comments,std_comments, hr_comments, teacher_comments, admin_eform_comment, admin_plform_comment, course_preference_comment FROM tblLTP_preview");
    }
