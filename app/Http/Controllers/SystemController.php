...
class SystemController extends Controller
{
 ...
 "ahmad.ahadi@wipo.int",
 "ahmad.musleh@un.org",
 "ahmads@un.org",
 "ahmed.ayoub@un.org",
 "ahmed.ghailan@un.org",
 "ahmed@intracen.org",
 "ahmed189@un.org",
 "ahmedmu@unhcr.org",
 "AHMEDRAFIE76@GMAIL.COM",
 "ahmet.dogan@mfa.gov.tr",
 "AHMET.ORNEK@WTO.ORG",
 "ahmetztoksoz@gmail.com",
 "ahodzic@ohchr.org",
 "AHOVSEPYAN@WMO.INT",
 "AHussain@wmo.int",
 "ai.odoriba@un.org",
 ...
 "aidai.kurmanova@un.org",
 "aidarakanea@who.int",
 "aija.bajard@formin.fi",
 "ailsa.jones@gmail.com",
 "aimielinska@unicef.org",
 "ainoa.polo@un.org",
 "aisha.bankole@un.org",
 "aisha.coke@international.gc.ca",
 "aitziber.echeverria@un.org",
 "ajackson@icrc.org",
 "ajankowska@intracen.org",
 "ajaz@unhcr.org",
 "ajkuna.thanati@un.org",
 "ajn@ipu.org",
 "ajovic@unicef.org",
 "akaralliu@hotmail.com",
 "akari.yamamoto@unctad.org",
 "akeah@kenyamission.ch",
 "akid141281@gmail.com",
 "akiko.hiratsuka@un.org",
 "akponton@intracen.org",
 "akram.h@fm.gov.jo",
 "akshatdewan@gmail.com",
 "AKURIU@OHCHR.ORG",
 "akushleyko@icrc.org",
 "al-daker@un.org",
 "al-jadily@un.org",
 ...
 "alberto.delogu@un.org",
 "alberto.gugl@gmail.com",
 "alberto.munisso@unctad.org",
 "ALBERTO.OSNAGO@WTO.ORG",
 "alberto.vilchezveleda@un.org",
 "albertosantibanez@gmail.com",
 "albine.vandeplasse@un.org",
 "aleksandracaric@gmail.com",
 "aleksei.syroezhko@un.org",
 "alessioa@unops.org",
 "alex_loden@yahoo.co.uk",
 "alex.kamarotos@defenceforchildren.org",
 "alex.mccusker@un.org",
 "alex.mejia@unitar.org",
 "alexander.came@scalingupnutrition.org",
 "alexander.mangwiro@un.org",
 "ALEXANDERN@UN.ORG",
 "alexandr.tvetcov@eubam.org",
 "alexandra.demiroz@gmail.com",
 "alexandra.gigant@un.org",
 "alexandra.laurent@un.org",
 "Alexandra.MACEJIN@bmeia.gv.at",
 "alexandrafedorova@gmail.com",
 "alexandre.carette@un.org",
 "alexandre.gadebski@un.org",
 "Alexandre.Genest@wto.org",
 "alexandre.skourikhine@un.org",
 "alexandre.souto@itamaraty.gov.br",
 "alexandros.hoc@un.org",
 "alexis.massot@wto.org",
 "alfirev@un.org",
 "ALHAIQUE@UN.ORG",
 "ali.fakher@undp.org",
 ...
 "ali.khaffane@un.org",
 "ali55@un.org",
 "alibech.mirelesdiaz@un.org",
 "alice.bonfatti@wilpf.org",
 "alice.kovarikova@un.org",
 "alice.mathew@un.org",
 "alicia@icanw.org",
 "alicja.kacprzak@un.org",
 "alicja.wielgus@wto.org",
 "ALII@UN.ORG",
 "alimuratnas@gmail.com",
 "alina.datsii@itu.int",
 "alina.novikova@un.org",
 "aline.haddad-gaide@un.org",
 "aline.stoessel@un.org",
 "aliona.normandin@gmail.com",
 "ALIP@UNHCR.ORG",
 "alis@unops.org",
 "alisher.mamadzhanov@un.org",
 "alison.freebairn@ifrc.org",
 "aliwak@icrc.org",
 "alix.marcastel@gmail.com",
 "alixi@ohchr.org",
 "Alkabak@un.org",
 "alkhairi@un.org",
 "alla.shlykova@un.org",
 "allan.kalungi@wto.org",
 "ALLANIDALEL@HOTMAIL.COM",
 "allyson.frias@un.org",
 "alma.montanini@iuf.org",
 "almudena.rueda@un.org",
 "almudena.ruiz@un.org",
 "alnablsi@un.org",
 "alondralmc@hotmail.com",
 "alphonce.mkama@un.org",
 "alshybani@libyanmission.ch",
 "altalli@intracen.org",
 "altymyshevaa@who.int",
 "alvarez6@un.org",
 "alvarezc@unhcr.org",
 "alvaro.fomperosa-rivero@wto.org",
 "alvi77@mail.ru",
 "alyni.lima@un.org",
 "am.baltar@delwalbru.be",
 "amabobakr4@gmail.com",
 "amal_al_sheikh@yahoo.com",
 "amalia_45@mail.ru",
 "amalver@ohchr.org",
 "amanda.howland@un.org",
 "amanda.kron@gmail.com",
 "amano@unhcr.org",
 "amar@uicc.org",
 "amaya2@un.org",
 "ameen2@un.org",
 "ameidinova@iom.int",
 "AMELEWORKAYTAGED@YAHOO.COM",
 "amelia.dearaujo@one.un.org",
 "Amelia.Santos-Paulino@unctad.org",
 "amelie.caillet@wto.org",
 "amelie.cournoyer@un.org",
 "amewolomenounga@icrc.org",
 "amie.figueiredo@un.org",
 "amilan@wmo.int",
 "AMIRALNABHANI88@GMAIL.COM",
 "amiri@un.org",
 "amlang@un.org",
 "amna.smailbegovic@un.org",
 "amonnet@ohchr.org",
 "amorenoramirez@icrc.org",
 "Amos.Taporaie@unctad.org",
 "amougouowono@un.org",
 "amoynihan@unicef.org",
 "amutobhatti@yahoo.co.jp",
 "amwangangi-lindsay@ohchr.org",
 "amwendwa@icrc.org",
 "amwenifumbo@ohchr.org",
 "amy-louise.shelver@un.org",
 "amy.smith@un.org",
 "an.cuypers@ohchr.org",
 "AN@UN.ORG",
 "ana.decastro@wto.org",
 "ana.hauert@un.org",
 "anagiulia.stella@un.org",
 "anahi.chavezruesta@un.org",
 "anamaria.escobar@ifrc.org",
 "anand.mamtora@un.org",
 "anantakafumi@gmail.com",
 "anapaula871@live.com",
 "anaprodh@yahoo.fr",
 "anastasia.nesvetailova@un.org",
 "anastasia.nicolle@un.org",
 "anavarrofusillo@gmail.com",
 "anayuin10@gmail.com",
 "andarcial@onuginebra.gob.ve",
 "ander.ruiz@maec.es",
 "andersen@unhcr.org",
 "andersoa@unhcr.org",
 "anderson.caluz@gmail.com",
 "anderson@refugepoint.org",
 "andra.otilia.nicolescu@gmail.com",
 "andre.sceia@un.org",
 "ANDREA.DWARIKA@GMAIL.COM",
 "andrea.silva3009@gmail.com",
 "andrei.laptev@wipo.int",
 "andrei.rusu@romaniaunog.org",
 "andres.delcastillo@docip.org",
 "andres.maldonadoguzman@gmail.com",
 "ANDRESUATRU@YAHOO.COM.MX",
 "andrew.hatfield@un.org",
 "andrew.johnson@un.org",
 "andrew.tait1@un.org",
 "andrey.novikov@un.org",
 "andrey.sitnov@un.org",
 "andriana.diana10@gmail.com",
    ];
