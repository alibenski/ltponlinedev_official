  ...
  <tbody>
    <tr>
      ...
      <td style="width:212.65pt;border:solid white 1.0pt;padding:0cm 6.0pt 0cm 6.0pt;" valign="top" width="284">
        ...
        <p class="MsoNormal" style="text-align:right;"><span lang="DE-CH" style="font-size:11px;font-family:Arial,sans-serif;">E-mail: CLM_language@unog.ch</span></p>
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 800px;">
  <tbody>
    <tr>
      <td></td>
      <td>
        <p class="MsoNormal" style="text-align:center;"><span style="font-family:Century Gothic,sans-serif;">Has successfully completed the following course:</span></p>
        <br>
      </td>
    </tr>
  </tbody>
