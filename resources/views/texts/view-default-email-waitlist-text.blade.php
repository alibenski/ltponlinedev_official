...
<head>
    ...
    <title>UNOG CLM Language Training Programme</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
<body width="100%" bgcolor="ffffff" style="margin: 0; mso-line-height-rule: exactly;">
    <center style="width: 100%; background: ffffff; text-align: left;">
        ...
        <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
            UNOG CLM Language Training Programme
        </div>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px;">
                <tr>
                    <td style="padding: 20px 0; text-align: center">
                        <img src="https://learning.unog.ch/sites/all/themes/sdlstheme/images/CLM-TextRight_En.jpg" width="260" height="93" alt="UNOG CLM" border="0" style="height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                    </td>
                </tr>
            </table>
            <!-- Email Header : END -->
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    <p>Dear Student,</p> 
                                    <p style="text-align: justify">This is to inform you that you are currently on a waiting list for a place in our Language Training Programme. You will be notified as soon as a place becomes available at your level within the first two weeks of the term, {{ $firstDayMonth }} - {{ $lastDayMonth }}.
                                    </p>
