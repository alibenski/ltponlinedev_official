...
<div class="container">
    <form class="well form-horizontal" method="POST" action="{{ route('schedules.update', $schedule->id) }}">
          <div class="form-group">
            <label for="sched_name">Schedule Description:</label>
            <textarea type="text" class="form-control input-lg" id="sched_name" name="sched_name" rows="1" style="resize:none;">{{ $schedule->name }}</textarea>
          </div>
