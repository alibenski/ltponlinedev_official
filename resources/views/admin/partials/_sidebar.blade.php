  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{ Request::is('admin') ? "active" : ""}}"><a href="{{ route('admin_dashboard') }}"><i class="fa fa-tachometer"></i> <span>Admin Dashboard</span></a></li>
        ...
        <li class="{{ Request::is('admin/course-schedule') ? "active" : ""}}"><a href="{{ route('course-schedule.index') }}"><i class="fa fa-calendar-o"></i> <span>Enrolment Schedule</span></a></li>
        ...
        <li class="treeview {{ Request::is('admin/terms*') ? "active" : ""}}">
        ...
        <li class="treeview {{ Request::is('admin/courses*') ? "active" : ""}}">
