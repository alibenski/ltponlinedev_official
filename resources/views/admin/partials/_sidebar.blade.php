  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="{{ route('preenrolment.index') }}"><i class="fa fa-file-o"></i> <span>Enrolment Forms</span></a></li>
        <li class=""><a href="{{ route('placement-form.index') }}"><i class="fa fa-file"></i> <span>Placement Test Forms</span></a></li>
