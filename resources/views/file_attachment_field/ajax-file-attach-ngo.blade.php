<div class="form-group{{ $errors->has('contractfile') ? 'is-invalid' : '' }}">
    <label for="contractfile" class="col-md-12 control-label"><strong>Please provide a copy of either of the following:</strong> <span style="color: red"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</span> <br />NGO badge or <br/> NGO contract </label>
    <div class="col-md-12">
