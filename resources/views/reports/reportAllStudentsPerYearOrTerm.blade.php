		...
		function assignToEventsColumns(data) {
		    ...
		    var table = $('#sampol').DataTable({
		        ...
		        "columns": [
						...
						// 		if (row.hasOwnProperty('courseschedules')) {
						// 			if (row.courseschedules != null) {
						// 				return row.courseschedules.prices.price_usd;
						// 			}
						// 		} 
						// 	return "No Price Set";
						// 	}
						...
						// 		if (row.hasOwnProperty('courseschedules')) {
						// 			if (row.courseschedules != null) {
						// 				return row.courseschedules.courseduration.duration_name_en;
						// 			}
						// 		} 
						// 	return "No Course Duration Set";
						// 	}
						// },
		        		{ "data": "DEPT" },  
