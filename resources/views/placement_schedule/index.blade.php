...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			...
			<h3>Latest Term:  {{ $next_term->Term_Code.' - '.$next_term->Term_Name.' - '.$next_term->Comments }}</h3>
		</div>
		
		<div class="col-md-2">
			<a href="{{ route('placement-schedule.create') }}" class="btn btn-lg btn-block btn-primary btn-h1-spacing">Create</a>
		</div>
		<div class="col-md-12">
			<hr>
		</div>
