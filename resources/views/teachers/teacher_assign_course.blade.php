        ...
        <div class="box box-info">
            ...
            <div class="box-body">
            	<div class="col-sm-6">
					...
					<div class="form-group">
						<label class="control-label">Comments: <span class="text-danger">(Required for Verify and Not Assign)</span></label>

						<textarea id="textarea-{{$element->eform_submit_count}}" name="teacher_comments" class="form-control course-no-change" maxlength="3500" @if(is_null($element->teacher_comments)) placeholder="Reason for Verify and Not Assigned status, 2nd prefered course to take and any important information, etc." @else placeholder="{{$element->teacher_comments}}" @endif></textarea>
						<br />
					...
					$("textarea[name='teacher_comments']").on('input keyup',function(e){
