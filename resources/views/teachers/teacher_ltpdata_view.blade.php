...
<div class="row col-sm-12">
	<a href="{{ route('teacher-search-user') }}" class="btn btn-default btn-space"><span class="glyphicon glyphicon-arrow-left"></span> Back to User Admin</a>
	...
	<h3>@if(Request::input('Term'))Term: {{ Request::input('Term') }} - {{ $term_info->Comments }} {{ date('Y', strtotime($term_info->Term_Begin )) }}@else Please Choose Term @endif</h3>
   	<div class="row">
   		<div class="col-md-12">
   			<form method="GET" action="{{ route('teacher-ltpdata-view', $id) }}">
			    ...
			    <div class="form-group">           
			    	...
			    	<a href="{{ route('teacher-ltpdata-view', $id) }}" class="filter-reset btn btn-danger"><span class="glyphicon glyphicon-refresh"></span></a>
			    </div>
			</form>
   		</div>
	</div>
				...
				<div class="row">
					<div class="col-sm-5 center-block">
						<div class="alert alert-info alert-dismissible">
							...
							No <u>Regular Enrolment form</u>(s) submitted for this Term.
						</div>
					</div>
				</div>
			@else
				...
				<div class="row">
					<div class="col-sm-5 center-block">
						<div class="alert alert-warning alert-dismissible">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
							<h4><i class="icon fa fa-ban"></i> Message:</h4>
							No <u>Placement Test Request form</u>(s) submitted for this Term.
						</div>
					</div>
				</div>
			@else
									...
									<tr @if($form->deleted_at) style="background-color: #eed5d2;" @else @endif>
										<td>
											...
											@endif --}}
                                                ...
                                                @if($form->deleted_at)
                                                    <span class="label label-danger margin-label">Cancelled </span>
												@else
													<span class="label label-success margin-label">Active </span>
												@endif
