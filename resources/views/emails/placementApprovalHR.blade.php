                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
                                        <tr>
                                            <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                                <a href="{{ route('approval.getplacementformdata2hr', [
                                                    Crypt::encrypt($input_course->id), 
                                                    Crypt::encrypt($input_course->Term)
                                                    {{-- Crypt::encrypt($input_course->INDEXID),  --}}
                                                    {{-- Crypt::encrypt($input_course->L),  --}}
                                                    {{-- Crypt::encrypt($input_course->eform_submit_count),  --}}
                            ...
                            <tr>
                                <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                                    ...
                                    <p style="margin: 0;">Une fois la décision validée, vous recevrez un courrier électronique de confirmation. Si vous changez de décision, veuillez contacter le secrétariat du Programme de formation linguistique par courrier électronique à clm_language@un.org</p>
                                </td>
                            </tr>
                        </table>
                    </td>
