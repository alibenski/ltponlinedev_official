                    ...
                    <ul  class="list-group">
                        @foreach($historical_data as $hist_datum)
                            ...
                            @else
                                ...
                                <a class="btn btn-default hidden" href="{{ route('pdfAttestation',['language' =>'En', 'download'=>'pdf', 'id'=> $hist_datum->id]) }}" target="_blank"><i class="fa fa-print"></i> Print certificate (EN)</a>
                                <a class="btn btn-default hidden" href="{{ route('pdfAttestation',['language' =>'Fr', 'download'=>'pdf', 'id'=> $hist_datum->id]) }}" target="_blank"><i class="fa fa-print"></i> Imprimer le certificat (FR)</a>
